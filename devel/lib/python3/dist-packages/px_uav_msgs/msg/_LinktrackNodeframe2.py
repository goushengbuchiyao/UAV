...
"""autogenerated by genpy from px_uav_msgs/LinktrackNodeframe2.msg. Do not edit."""
import codecs
import sys
...
class LinktrackNodeframe2(genpy.Message):
  ...
  _type = "px_uav_msgs/LinktrackNodeframe2"
...
float32 rx_rssi"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','float32[3]','float32[3]','float32[3]','float32[3]','float32[4]','float32[3]','float32[3]','px_uav_msgs/LinktrackNode2[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = px_uav_msgs.msg.LinktrackNode2()
        _x = val1
        start = end
        end += 14
