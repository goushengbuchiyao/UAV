...
(cl:defclass <TargetsInFrame> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (targets
    :reader targets
    :initarg :targets
    :type (cl:vector uav_msgs-msg:Target)
   :initform (cl:make-array 0 :element-type 'uav_msgs-msg:Target :initial-element (cl:make-instance 'uav_msgs-msg:Target)))
   (rois
    :reader rois
    :initarg :rois
    :type (cl:vector uav_msgs-msg:ROI)
   :initform (cl:make-array 0 :element-type 'uav_msgs-msg:ROI :initial-element (cl:make-instance 'uav_msgs-msg:ROI)))
...
(cl:defmethod cl:initialize-instance :after ((m <TargetsInFrame>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TargetsInFrame)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uav_msgs-msg:<TargetsInFrame> is deprecated: use uav_msgs-msg:TargetsInFrame instead.")))
...
(cl:defmethod frame_id-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:frame_id-val is deprecated.  Use uav_msgs-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:height-val is deprecated.  Use uav_msgs-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:width-val is deprecated.  Use uav_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'fps-val :lambda-list '(m))
(cl:defmethod fps-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:fps-val is deprecated.  Use uav_msgs-msg:fps instead.")
  (fps m))

(cl:ensure-generic-function 'fov_x-val :lambda-list '(m))
(cl:defmethod fov_x-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:fov_x-val is deprecated.  Use uav_msgs-msg:fov_x instead.")
  (fov_x m))

(cl:ensure-generic-function 'fov_y-val :lambda-list '(m))
(cl:defmethod fov_y-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:fov_y-val is deprecated.  Use uav_msgs-msg:fov_y instead.")
  (fov_y m))

(cl:ensure-generic-function 'targets-val :lambda-list '(m))
(cl:defmethod targets-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:targets-val is deprecated.  Use uav_msgs-msg:targets instead.")
  (targets m))

(cl:ensure-generic-function 'rois-val :lambda-list '(m))
(cl:defmethod rois-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:rois-val is deprecated.  Use uav_msgs-msg:rois instead.")
  (rois m))

(cl:ensure-generic-function 'no_track_frame_count-val :lambda-list '(m))
(cl:defmethod no_track_frame_count-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:no_track_frame_count-val is deprecated.  Use uav_msgs-msg:no_track_frame_count instead.")
...
(cl:defmethod tracking_state-val ((m <TargetsInFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:tracking_state-val is deprecated.  Use uav_msgs-msg:tracking_state instead.")
  (tracking_state m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TargetsInFrame>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'targets)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'uav_msgs-msg:Target))
  ...
  (cl:let ((vals (cl:slot-value msg 'rois)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'uav_msgs-msg:ROI))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
