...
(cl:defmethod cl:initialize-instance :after ((m <PositionReference>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionReference)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px_uav_msgs-msg:<PositionReference> is deprecated: use px_uav_msgs-msg:PositionReference instead.")))
...
(cl:defmethod Move_frame-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px_uav_msgs-msg:Move_frame-val is deprecated.  Use px_uav_msgs-msg:Move_frame instead.")
  (Move_frame m))

(cl:ensure-generic-function 'time_from_start-val :lambda-list '(m))
(cl:defmethod time_from_start-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px_uav_msgs-msg:time_from_start-val is deprecated.  Use px_uav_msgs-msg:time_from_start instead.")
  (time_from_start m))
