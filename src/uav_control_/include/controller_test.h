...
class Controller_Test
{
    public:
        ...
        px_uav_msgs::UAVCommand Circle_trajectory_generation(float time_from_start);

        px_uav_msgs::UAVCommand Eight_trajectory_generation(float time_from_start);

        px_uav_msgs::UAVCommand Step_trajectory_generation(float time_from_start);

        px_uav_msgs::UAVCommand Line_trajectory_generation(float time_from_start);
...
px_uav_msgs::UAVCommand Controller_Test::Circle_trajectory_generation(float time_from_start)
{
    px_uav_msgs::UAVCommand Circle_trajectory;
    float omega;
    if( circle_radius != 0)
    {
...
px_uav_msgs::UAVCommand Controller_Test::Line_trajectory_generation(float time_from_start)
{
    px_uav_msgs::UAVCommand Line_trajectory;
    float omega;
    if( circle_radius != 0)
    {
        omega = direction * fabs(linear_vel / circle_radius);
...
px_uav_msgs::UAVCommand Controller_Test::Eight_trajectory_generation(float time_from_start)
{
    ...
    px_uav_msgs::UAVCommand Eight_trajectory;
...
px_uav_msgs::UAVCommand Controller_Test::Step_trajectory_generation(float time_from_start)
{
    px_uav_msgs::UAVCommand Step_trajectory;
